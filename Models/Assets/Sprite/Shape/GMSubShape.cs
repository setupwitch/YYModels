...
public class GMSubShape : ResourceBase
{
    ...
    public List<int> AntiAliasingLines { get; set; }

    /// <summary>
    /// Directional vectors in the subshape that use antialiasing.
    /// </summary>
    [GameMakerProperty("AAVectors")]
    public List<Point> AntiAliasingVectors { get; set; }
    ...
    public List<int> LineTris { get; set; }
    ...
    public List<uint> PointColours { get; set; }
